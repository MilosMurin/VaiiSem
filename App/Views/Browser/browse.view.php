...
<div class="row  d-flex align-items-center justify-content-center" style="margin: 0 auto">
    <?php for ($i = 0; $i < sizeof($data["algs"]); $i++) { ?>
		<div id="<?= $i ?>" class="mb-3 py-2 myBorder w-66" style="background-color: <?= $data["color"][$i] ?>">
